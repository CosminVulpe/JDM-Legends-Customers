...
public class CustomerSignController {
    ...
    @PostMapping("/sign")
    public ResponseEntity<HttpStatus> sign(@RequestBody @Valid CustomerEmailAddressRequest request) {
...
record CustomerEmailAddressRequest(@NotBlank String emailAddress, @NotBlank String pwd) {
}
